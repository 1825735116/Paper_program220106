...
X00=[pos1(1)/1;0;0];Y00=[pos1(2)/1;0;0];Z00=[pos1(3)/1;0;0];
...
for i=1:MyTotalStep
    ...
    yx1=[pos1(1)/1];yy1=[pos1(2)/1];yz1=[pos1(3)/1];
...
%     MyTheta=MyTheta+u*T;
    ...
    position_record=[position_record;pos1(1)/1,pos1(2)/1,pos1(3)/1];
...
dlmwrite('plan_jointacc_kal1.txt', MyThetaAccPlot);
dlmwrite('plan_jointvel_kal1.txt', MyThetaVelocityPlot);
